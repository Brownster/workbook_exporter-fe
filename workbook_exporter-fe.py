...
def run_exporters(selected_exporter_names, output_file, output_dir, file_path):
    ...
    try:
        ...
        print('Error', 'Please enter a valid starting value for the listen port')
        return
    ...
    if not selected_exporter_names:
        print('Error', 'Please select at least one exporter')
        return
    ...
    print('Success', 'Exporters completed')
